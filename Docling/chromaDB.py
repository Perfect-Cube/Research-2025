...
def hybrid_search(query, top_k=3, filter_doc=None):
    ...
    # For simplicity, we'll just use dense retrieval here; you can add BM25 as before
    best_results = []
    for id in top_ids:
...
# Interactive Query Loop (simplified, adjust as needed)
while True:
...
#     # Build combined text using precomputed page information to avoid nested f-string issues.
#     lines = []
#     for res in best_results:
