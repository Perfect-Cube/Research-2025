...
def translate_german_to_english(text):
    ...
    # Load the tokenizer and model from the pretrained model
            ...
            conversation = [
                {
                    ...
                    "content":[
                        {
                            "type":"text",
                            "text":"You are an AI agent of Volkswagen. Give answers to user's questions in detail. Give answers from retrieved text and image only. Respond in both English and German."
                        }
                    ]
                },
                {
            ...
            conversation = [
                {
                    ...
                    "content":[
                        {
                            "type":"text",
                            "text":"You are an AI agent of Volkswagen. Give answers to user's questions in detail. Give answers from retrieved text only. Respond in both English and German."
                        }
                    ]
                },
                {
